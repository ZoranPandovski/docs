...
![SELECT FROM us_consumption](/docs/assets/tutorials/aitables-postgresql/select_table.png)
...
![MindsDB Schema](/docs/assets/tutorials/aitables-postgresql/list_schema.png)
...
![Status](/docs/assets/tutorials/aitables-postgresql/select_status.png)
...
![SELECT FROM model](/docs/assets/tutorials/aitables-postgresql/select_model.png)
